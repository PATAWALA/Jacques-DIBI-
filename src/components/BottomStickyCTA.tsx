...
export default function BottomStickyCTA() {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-40 flex lg:hidden justify-center pb-3 pointer-events-none">
      <div className="pointer-events-auto flex items-center gap-3 bg-white border border-gray-200 shadow-xl rounded-xl px-4 py-3 mx-4 max-w-sm w-full animate-slide-up">
